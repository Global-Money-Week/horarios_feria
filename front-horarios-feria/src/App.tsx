    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="container-page space-y-6 flex-1">
          <div className="mt-2 bg-white/80 backdrop-blur rounded-2xl px-4 py-3 flex items-center justify-center">
            <p className="text-sm md:text-base text-[#6c757d] max-w-3xl font-myriad text-center">
